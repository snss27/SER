...
namespace SER.Database.Migrations
{
    ...
    [Migration("20250608193407_add_users")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SER.Database.Models.Students.StudentEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("SocialStatuses")
                        .IsRequired()
                        .HasColumnType("int[]")
                    ...
                    b.Property<string>("TargetAgreementNumber")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
            ...
            modelBuilder.Entity("SER.Database.Models.Users.UserEntity", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("bytea")
                        .HasColumnName("id");
