        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    representative_alias = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    target_agreement_number = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AdditionalQualificationEntityStudentEntity",
                columns: table => new
                {
                    AdditionalQualificationsId = table.Column<byte[]>(type: "bytea", nullable: false),
                    StudentEntityId = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalQualificationEntityStudentEntity", x => new { x.AdditionalQualificationsId, x.StudentEntityId });
                    table.ForeignKey(
                        name: "FK_AdditionalQualificationEntityStudentEntity_additional_quali~",
                        column: x => x.AdditionalQualificationsId,
                        principalTable: "additional_qualifications",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdditionalQualificationEntityStudentEntity_students_Student~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalQualificationEntityStudentEntity_StudentEntityId",
                table: "AdditionalQualificationEntityStudentEntity",
