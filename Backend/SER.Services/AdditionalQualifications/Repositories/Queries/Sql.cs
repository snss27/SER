...
internal class Sql
{
	...
	public static String AdditionalQualifications_Remove =>
		SqlFileProvider.GetQuery(folder: "AdditionalQualifications");

	public static String AdditionalQualifications_Get => SqlFileProvider.GetQuery(folder: "AdditionalQualifications");

	public static String AdditionalQualifications_GetPage =>
		SqlFileProvider.GetQuery(folder: "AdditionalQualifications");
}